...
import { FileCode2, Terminal as TerminalIcon, PlayCircle, Wand2, Clock, Calendar, Pencil, Check, X, FolderTree, Sparkles } from 'lucide-react';
...
import { EditorAssistant } from '@/components/assistant/EditorAssistant';
        ...
        if (!compilationError && compilations && compilations.length > 0) {
          ...
          setLastCompilationResult({
            ...
            details: {
              ...
              compilation_time: lastCompilation.compilation_time || 0,
